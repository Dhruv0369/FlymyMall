                ...
                <div className="header-main white">
                    <div className="container">
                        <div className="menu-flex d-flex align-items-center justify-content-between">
                            <div className="logo">
                                <NavLink to="/">
                                    <img className="logo-white" src={logowhite} alt="White Logo" />
                                    <img className="logo-color" src={logo} alt="Color Logo" />
                                </NavLink>
                            </div>
                            ...
                            <div className="btn-menu">
                                ...
                                <img className="menu-bars-dark" src={menu} alt="Dark Menu" />
                            </div>
                        </div>
                        {/* mobile-menu */}
                            ...
                            <div className="mobile-menu">
                                <div className="top">
                                    <div className="close-menu">
                                        {/* Close Menu Icon */}
                                        <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M9.75 9.75L14.25 14.25M14.25 9.75L9.75 14.25M21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12Z" stroke="#231F20" strokeOpacity="0.56" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                    <div className="logo">
                                        <NavLink to="/">
                                            <img className="logo-mobile" src={logo} alt="Mobile Logo" />
                                        </NavLink>
                                    </div>
