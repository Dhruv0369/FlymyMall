                    ...
                    <div className="form-area login-form">
                        ...
                        <form action="" method="post">
                                ...
                                <div className="left">
                                    ...
                                    <div className="checkbox">
                                        <input
                                            ...
                                            name="agree"
                                        />
                                        <label htmlFor="agree" className="checkbox-custom-label">
                            ...
                            <div className="btn-area">
                                ...
                                <a href="javascript:void()" className="btn btn-dark">
                                    <span>
                                        <svg
                        ...
                        <div className="form-footer">
                            <p>
                                Don’t have an account? <Link to="/resiter">Register</Link>
                            </p>
                        </div>
                    </div>
                </div>
